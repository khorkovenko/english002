...
return (  
    <Dialog  
        ...
        modal  
        closable={false}  
        style={{ width: "80vw", maxWidth: "700px", padding: "0" }}  
    ...
    >  
        <canvas  
            ...
            style={{ border: "2px solid #007ad9", borderRadius: "8px", cursor: "crosshair", marginBottom: "1rem", background: "#fff8e7" }}  
        />  
